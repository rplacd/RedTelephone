...
If you've just checked this out from source, this is an MVC2/.net 4 app. You'll also need log4net (1.2.10 is used), Jayrock (0.9.12915), and the Spark view generator (1.5.0.0, MVC2, NET4). Read and write permission to what will be configured as the "home" folder is required for logging and for references in templates. You might want to set up the database using the bundled script; at the very least references to the Permissions table (CRF_PNM) are hard-coded.

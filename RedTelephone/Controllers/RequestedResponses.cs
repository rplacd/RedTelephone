...
namespace RedTelephone.Controllers {
    [ValidateInput(false)]
    public class RequestedResponsesController : RedTelephoneController {
        ObjectSet<RequestedResponse> table = (new ModelsDataContext()).RequestedResponses;
        String className = "RequestedResponsesController";
            ...
            return authenticatedAction(new String[] { "UR" }, () => formAction(
                    ...
                    () => sideEffectingAction(() => {
                        ...
                        foreach (KeyValuePair<String, Dictionary<String, String>> itemPair in formVars) {
                            ...
                            RequestedResponse possibleItem = table.FirstOrDefault(p => p.code == code);

                            //VALIDATION HAPPENS HERE
                            validationLogPrefix = className + ".Index";
                            ValidateStrLen(itemPair.Value["description"], 32, "Requested response descriptions");
                            //AND THEN ENDS.
                            ...
                            if (possibleItem != null) {
                                ...
                                possibleItem = new RequestedResponse();

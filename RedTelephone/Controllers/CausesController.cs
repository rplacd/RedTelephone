...
namespace RedTelephone.Controllers {
    [ValidateInput(false)]
    public class CausesController : RedTelephoneController {
        ObjectSet<Cause> table = (new ModelsDataContext()).Causes;
        String className = "CausesController";
            ...
            return authenticatedAction(new String[] { "UR" }, () => formAction(
                    ...
                    () => sideEffectingAction(() => {
                        ...
                        foreach (KeyValuePair<String, Dictionary<String, String>> itemPair in formVars) {
                            ...
                            Cause possibleItem = table.FirstOrDefault(p => p.code == code);
